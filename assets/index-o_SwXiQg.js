...
var BottomNav = ({ activeTab, setActiveTab }) => {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					className: `nav-item btn-interactive ${activeTab === item.id ? "active" : ""}`,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: filteredMembers.length > 0 ? filteredMembers.map((member) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
									strokeLinecap: "round",
									strokeLinejoin: "round",
									d: "M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 01-.923 1.785 4.75 4.75 0 003.433-.908 4.385 4.385 0 001.631.302c.046 0 .092-.002.138-.005z"
								})
							})
						})]
					})]
				}, member.id)) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "검색 결과가 없습니다." })]
				})
			})
		]
	});
...
//#endregion
//#region src/components/MemberDetail.tsx
var MemberDetail = ({ member, onClose }) => {
...
var getFirstSaturday = (year, month) => {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "dday-number",
						children: nextMeeting.dday === 0 ? "D-Day 바로 오늘!" : `D-${nextMeeting.dday}`
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "dday-info",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "이름 *" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "text",
								className: "input-field",
								required: true,
								value: formData.name,
	...
	(0, import_react.useEffect)(() => {
		fetch("/api/members").then((response) => {
			...
			if (savedMembers) try {
				...
				localStorage.setItem("namwoohui_members", JSON.stringify(members_default));
			}
			else {
				setMembers(members_default);
				localStorage.setItem("namwoohui_members", JSON.stringify(members_default));
